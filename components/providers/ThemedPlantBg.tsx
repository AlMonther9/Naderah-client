...
const VintagePlantBackground = ({ children }: { children: ReactNode }) => {
  return (
...
// Earthy Theme
const EarthyPlantBackground = ({ children }: { children: ReactNode }) => {
  return (
...
// Green Theme
const GreenPlantBackground = ({ children }: { children: ReactNode }) => {
  return (
    <div className="relative min-h-screen overflow-hidden font-sans">
